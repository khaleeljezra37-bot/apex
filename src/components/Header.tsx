    ...
    <>
      <header className="h-20 w-full flex items-center justify-between px-6 lg:px-10 shrink-0 border-b border-white/5 bg-transparent relative z-20">
        ...
        <div className="flex items-center gap-3 lg:gap-4">
          <button className="hidden sm:flex group items-center px-5 py-2.5 bg-white/5 hover:bg-white/10 border border-white/10 rounded-full transition-all backdrop-blur-md shadow-lg">
            <Play
              className="w-4 h-4 mr-2 text-white/50 group-hover:text-white"
              fill="currentColor"
            />
          ...
          <button className="group flex flex-1 sm:flex-none items-center px-5 py-2.5 bg-white/10 hover:bg-white/20 border border-white/20 rounded-full transition-all backdrop-blur-md text-white hover:text-white shadow-lg">
              ...
              <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-gray-700 to-gray-500 border border-white/20 flex items-center justify-center mr-3 overflow-hidden shadow-inner group/avatar relative">
                {user?.avatar ? (
                  <>
                    <img
                      src={user.avatar}
                      className="w-full h-full object-cover group-hover/avatar:hidden"
                      alt="Profile"
                    />
