...
const mockWorkspace: InstanceNode[] = [
  ...
  },
  {
    ...
    type: "service",
    icon: Gamepad2,
    children: [{ id: "player1", name: "RobloxDev", type: "model", icon: Box }],
  },
  {
    id: "lighting",
    name: "Lighting",
  ...
  return (
    <div>
      ...
      >
        ...
        <span className="text-[13px] text-white/90 select-none group-hover:text-white">
          {node.name}
        </span>
      </div>
  ...
  return (
    <div className="flex-1 h-full w-full border border-white/5 bg-[#0a0a0a] rounded-2xl overflow-hidden flex flex-col shadow-2xl relative z-10 hidden sm:flex">
      <div className="p-4 border-b border-white/5 bg-[#111] flex items-center justify-between">
        ...
        <div className="bg-white/5 px-2 py-1 rounded text-[10px] text-white/40 tracking-wider">
          LIVE
        </div>
      </div>
